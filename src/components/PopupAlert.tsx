...
export default function PopupAlert() {
  ...
  return (
    <div className='fixed z-[100] flex h-screen w-full select-none items-center justify-center '>
      <div className='w-[85%] max-w-sm rounded-xl border border-white/10 bg-neutral-900/80 shadow-[0px_0px_100vh_100dvh_#00000075,0_0_10px_10px_#00000005] backdrop-blur-lg'>
